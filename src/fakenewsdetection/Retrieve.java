...
public class Retrieve {
	...
	private static final String CONSUMER_KEY = "FsMXPanIlpAKZRrayMrA4Dmug";
	private static final String CONSUMER_SECRET = "nbRJt22Bi7r2ht1uGCRagzaGsN6URMmLjBCm8nL5pnw80s0Xb4";
	...
	//private static final String SEARCH_TERM			= "#engineeringproblems";

        private static final String SEARCH_TERM	= "@fakingnews";
	/**
	...
	public static Twitter getTwitter()
	{
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        for (int queryNumber=0;queryNumber < MAX_QUERIES; queryNumber++)
                        {
                            ...
                            q.resultType(Query.RECENT);//ResultType.mixed);						// Get all tweets
                            ...
                            for (Status s: r.getTweets())				// Loop through all the tweets...
                            {
                                ...
                                fw.write(s.getCreatedAt().toString()+"\t"+cleanText(s.getText()));
                                fw.write("\r\n");
                                fw.flush();
		...
		{
			//Logger.getLogger(FetchData.getName()).log(Level.SEVERE, null, ex);
